...
public class Solucao {
	...
	public static void main(String[] args) {
		...
		bst.sucessor(bst.busca(n), caminho);
...
class BST {
	...
	public Node sucessor(Node no, ArrayList<Integer> caminho) {
		if (no == null)
			return null;

		caminho.add(no.valor);
		if (no.direito != null)
			return this.encontraExtremo(no.direito, true, caminho);

		Node atual = no;
		Node aux = no.pai;
		while (aux != null && atual == aux.direito) {
