...
class BST {
	...
	public Node busca(int valor, ArrayList<Integer> caminho) {
		return busca(this.raiz, valor, caminho);
	}

	private Node busca(Node atual, int valor, ArrayList<Integer> caminho) {
		if (atual == null)
			return null;

		caminho.add(atual.valor);

		return (valor < atual.valor) ? busca(atual.esquerdo, valor, caminho)
				: (valor > atual.valor) ? busca(atual.direito, valor, caminho) : atual;
	}
