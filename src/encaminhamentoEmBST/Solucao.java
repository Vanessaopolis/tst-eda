...
public class Solucao {
	...
	public static void main(String[] args) {
		...
		System.out.println(bst.emOrdem());
		System.out.println(bst.posOrdem());
...
class BST {
	...
	private void emOrdem(Node no, ArrayList<Integer> elementos) {
		if (no == null)
			return;

		emOrdem(no.esquerdo, elementos);
		elementos.add(no.valor);
		emOrdem(no.direito, elementos);
	}

	private void posOrdem(Node no, ArrayList<Integer> elementos) {
		if (no == null)
			return;

		posOrdem(no.esquerdo, elementos);
		posOrdem(no.direito, elementos);
		elementos.add(no.valor);
	}
