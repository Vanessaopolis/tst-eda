...
class BST {
	...
	public int contaFolhas() {
		return this.contaFolhas(this.raiz);
	}

	private int contaFolhas(Node atual) {
		if (atual == null)
			return 0;

		return ((atual.ehFolha()) ? 1 : 0) + this.contaFolhas(atual.esquerdo) + this.contaFolhas(atual.direito);
	}
