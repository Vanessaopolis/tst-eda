...
public class Solucao {
	...
	public static void main(String[] args) {
		...
		System.out.println(bst.contaElementosMenores(n));
...
class BST {
	...
	public int contaElementosMenores(int n) {
		if (this.estaVazia())
	...
	private int contaElementosMaiores(int n, Node no) {
		...
		if (no.valor < n)
			return 1 + tamanho(no.esquerdo) + contaElementosMaiores(n, no.direito);
		else
			return contaElementosMaiores(n, no.esquerdo);
	}
